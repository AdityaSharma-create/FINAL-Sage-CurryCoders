  ...
  return (
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
        ...
        <p className="productdisplay-right-category"><span>Category :</span> College, Pre mmed</p>
        <p className="productdisplay-right-category"><span>Tags :</span> Class of 2026, Entreprenuer </p>
      </div>
    </div>
  );
};
